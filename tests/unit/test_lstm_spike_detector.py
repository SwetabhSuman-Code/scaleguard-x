...
class TestLSTMPredictions:
    ...
    def test_detect_normal_traffic(self, trained_model):
        ...
        assert spike_prob < 0.4, \
            f"False positive on normal traffic: spike_prob={spike_prob:.2f}"
    ...
    def test_detect_spike_traffic(self, trained_model):
        ...
        assert spike_prob > 0.5, \
            f"Failed to detect spike: spike_prob={spike_prob:.2f}"
...
class TestLSTMVsProphet:
    ...
    def test_lstm_catches_sudden_spikes(self):
        ...
        assert spike_prob > 0.6, \
            f"LSTM missed sudden spike: {spike_prob:.2f}"
