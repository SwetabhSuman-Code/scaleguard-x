...
class ProphetForecaster:
    ...
    def predict_next_10_minutes(self, current_data: pd.DataFrame) -> Dict:
        ...
        future = self.model.make_future_dataframe(periods=2, freq="5min", include_history=False)
        ...
        spike_probability = self._calculate_spike_probability(next_period, current_value)
    ...
    def predict_horizon(self, current_data: pd.DataFrame, horizon_minutes: int = 60) -> Dict:
        """
        ...
        return {"horizon_minutes": horizon_minutes, "predictions": predictions}
    ...
    def _calculate_confidence(self, prediction, recent_data: pd.DataFrame) -> float:
        """
